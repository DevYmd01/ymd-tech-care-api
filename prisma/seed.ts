...
async function main() {
  ...
  const formats = [
    ...
    },
    {
      ...
      document_type_code: 'ISSUE-STOCK',
      prefix: 'ISSUE-STOCK',
      pattern: '{PREFIX}-{BR}-{YYYY}{MM}-{RUN}',
      seq_length: 4,
      running_cycle: RunningCycle.YEAR,
  ...
  const salesDocuments = [
    ...
    { 
      ...
      system_document_name: 'รายการใบโอนย้ายสินค้าออก',
      system_document_name_eng: 'Transfer Requisition',
      sort_order: 1,
      is_active: true,
    },
      ...
      system_document_name: 'รายการใบโอนย้ายสินค้าเข้า',
      system_document_name_eng: 'Transfer Requisition',
      sort_order: 1,
      is_active: true,
    },
