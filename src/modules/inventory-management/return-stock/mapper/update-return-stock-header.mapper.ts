...
export class UpdateReturnStockHeaderMapper {
    static toPrismaUpdateInput(
        data: UpdateReturnStockHeaderDto,
        stock_effect_ic?: number | null,
        doc_type_no?: number | null,
        doc_type_name?: string | null,
    ): Prisma.return_issue_stock_headerUpdateInput {
        return {
            ...(data.return_stock_date && { return_stock_date: data.return_stock_date }),
            ...(data.issue_stock_id && { issue_stock_header: { connect: { issue_stock_id: data.issue_stock_id } } }),
