...
import { UpdatePriceListLineDto } from './update-price-list-line.dto';

export class UpdatePriceListHeaderDto {
    ...
    @Type(() => UpdatePriceListLineDto)
    price_list_lines?: UpdatePriceListLineDto[];
