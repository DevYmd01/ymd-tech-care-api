...
export class UpdateMultiPriceItemMapper {
  static toPrisma(dto: CreateMultiPriceItemDto): Prisma.multi_price_itemUpdateInput {
    return {
      item_from_qty: dto.item_from_qty,
      ...(dto.item_id ? { item: { connect: { item_id: dto.item_id } } } : {}),
